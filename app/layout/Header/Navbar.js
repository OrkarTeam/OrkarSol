...
const Navbar = () => {
	...
	return (
		<div
			className={clsx(['scene__one', 'scene__two', 'h-32', 'flex', 'justify-center', 'items-center'])}>
				...
				<div>
					<ul className='flex items-center gap-10'>
						<Link href={routes.collection}>
							<li className='text-white font-[400] text-[14px] cursor-pointer leading-[19px]'>Collection</li>
						</Link>
						<Link href={routes.rewards}>
							<li className='text-white font-[400] text-[14px] cursor-pointer leading-[19px]'>Rewards</li>
						</Link>
						<Link href={routes.auction}>
							<li className='text-white font-[400] text-[14px] cursor-pointer leading-[19px]'>Auction</li>
						</Link>
					</ul>
				</div>
				<div>
			...
			{walletModal && ( // Render the modal only if showModal is true
				<WalletModal onClose={handleModalClose}>
					<div>
						...
						<p className='text-[#C2C2C2] font-[400] text-[28.4176px] leading-[30px]'>
